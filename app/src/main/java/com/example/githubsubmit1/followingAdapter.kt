...
class FollowingAdapter(private val listUsers: ArrayList<UserFollowingResponseItem>): RecyclerView.Adapter<FollowingAdapter.CardViewViewHolder>() {
...
//        fun onItemClicked(data:UserFollowingResponseItem)
//    }

    fun setFollowingData(data: List<UserFollowingResponseItem>){
        listUsers.clear()
